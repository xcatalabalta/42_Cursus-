...
/*   Updated: 2025/01/02 07:59:50 by fcatala-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	Fixed output(-this->toFloat());
	return (output);
}

//Friend arithmetic operators (advanced concept not required)
Fixed operator*(const float lhs, const Fixed &rhs)
{
	Fixed lhsFixed(lhs);
	return (lhsFixed * rhs);
}

...
if command -v tree >/dev/null 2>&1; then
    tree -a -I '.git' $TARGET_DIR >> "$OUTPUT_FILE"
else
...
echo "===============================================" >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
ls -laR $TARGET_DIR/scripts >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
ls -laR $TARGET_DIR/secrets >> "$OUTPUT_FILE"
if [ ! -d $TARGET_DIR"/secrets" ]; then
    echo $TARGET_DIR"/secrets does not exist" >> "$OUTPUT_FILE"
fi
echo "" >> "$OUTPUT_FILE"
ls -laR $TARGET_DIR/srcs >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
find $TARGET_DIR/srcs -type f ! -name "$OUTPUT_FILE" | while read -r file; do
    echo "-----------------------------------------------" >> "$OUTPUT_FILE"
...
echo "-----------------------------------------------" >> "$OUTPUT_FILE"
echo "Directory: "$TARGET_DIR"/secrets" >> "$OUTPUT_FILE"
echo "-----------------------------------------------" >> "$OUTPUT_FILE"
if [ ! -d $TARGET_DIR"/secrets" ]; then
    echo "" >> "$OUTPUT_FILE"
    echo $TARGET_DIR"/secrets does not exist" >> "$OUTPUT_FILE"
...
find $TARGET_DIR/secrets -type f ! -name "$OUTPUT_FILE" | while read -r file; do
    echo "-----------------------------------------------" >> "$OUTPUT_FILE"
    echo "File: $file" >> "$OUTPUT_FILE"
    echo "-----------------------------------------------" >> "$OUTPUT_FILE"
...
cat $TARGET_DIR/Makefile >> "$OUTPUT_FILE"
...
echo "-----------------------------------------------" >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
find $TARGET_DIR/scripts -type f ! -name "$OUTPUT_FILE" | while read -r file; do
    echo "-----------------------------------------------" >> "$OUTPUT_FILE"
    echo "File: $file" >> "$OUTPUT_FILE"
    echo "-----------------------------------------------" >> "$OUTPUT_FILE"

...
/*   Updated: 2025/01/21 18:10:17 by fcatala-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void): _name("defaultCT"), _hit_pts(10), _energy_pts(10), _attack_dmg(0)
{
...
{
    std::cout << "\033[3mClapTrap copy constructor called\033[0m" << std::endl;
    *this = other;
}
...
//Not required, but useful and/or just for fun
